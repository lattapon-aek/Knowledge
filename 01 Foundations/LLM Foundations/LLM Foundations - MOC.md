...
- [[01 Foundations/LLM Foundations/Bridge/15 - ML Primitives สำหรับ LLM|15 - ML Primitives สำหรับ LLM]] — bridge note สำหรับ ML fundamentals ที่จำเป็นต่อการเข้าใจ LLM
- [[04 Synthesis/Bridge/Synthesis - Weights, Context, Retrieval และ Tools|Weights, Context, Retrieval และ Tools]] — bridge note สำหรับแยกบทบาทของ weights/context/retrieval/tools
