...
flowchart LR
    ...
    B --> C["Model"]
    C --> D["Structured output<br/>(JSON / schema-bound object)"]
...
```mermaid
flowchart TD
    A["Task"] --> B{"Need only structured data<br/>or need external action?"}
...
- [[02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน|Tools: การออกแบบและทำงาน]]
