...
- [[03 Tools/Claude Code/04 - 1 Session vs Subagents vs Agent Teams|1 Session vs Subagents vs Agent Teams]] — Workflow = 1 Session หรือ Sequential Subagents / Agent = Dynamic Agent Teams ที่ตัดสินใจเองว่าจะทำอะไรต่อ
