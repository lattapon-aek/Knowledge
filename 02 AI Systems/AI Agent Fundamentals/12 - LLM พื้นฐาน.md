...
โน้ตนี้เป็น bridge note สำหรับ `AI Agent Fundamentals`:
...
| System prompt / messages / chat templates ใน runtime | [[13 - Messages, System Prompt และ Chat Templates]] |
| Tool schemas / tool calling / MCP runtime contract | [[14 - Tools: การออกแบบและทำงาน]] |
