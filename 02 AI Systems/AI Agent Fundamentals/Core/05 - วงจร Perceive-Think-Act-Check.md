...
- [[03 Tools/Claude Code/Core/01 - Claude Code คืออะไร|Claude Code Agentic Loop]] — Agentic Loop ของ Claude Code เป็น PTAC จริง: วางแผน → Read → วิเคราะห์ → Edit → Bash รัน test → ตรวจว่าเสร็จไหม → วนซ้ำ
