...
- [[03 Tools/Claude Code/Core/27 - Claude Code vs OpenClaw|Claude Code vs OpenClaw]] — เปรียบเทียบ architecture choices ของ 2 agent systems ต่าง deployment context
