...
tool orchestration คือชั้นที่คุมว่า agent จะเลือก, เรียก, ลำดับ, ตรวจผล, และสลับระหว่าง tools อย่างไร
...
ดังนั้น framework ต่างกันที่ orchestration model ของ tools
...
- [[02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน]] — ความเข้าใจพื้นฐานของ tools
