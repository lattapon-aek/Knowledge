...
- [[03 Tools/Claude Code/Core/28 - Session Persistence and Recovery|Claude Code Session Persistence]] — ตัวอย่าง production implementation ของ append-only persistence, resume/fork, permission non-restoration
