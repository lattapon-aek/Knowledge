...
- [[02 AI Systems/RAG/Core/RAG - Security and Source Trust]] — retrieved/tool content เป็น untrusted input ใน RAG
- [[02 AI Systems/Guardrails/Core/05 - Fallback Policies]] — เมื่อ tool call ไม่ปลอดภัยควร fallback ยังไง
- [[02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน]] — runtime ของ tool use
