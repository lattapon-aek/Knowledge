...
- [[02 AI Systems/AI Agent Fundamentals/Core/04 - สถาปัตยกรรม Agent_ Model + Tools + Orchestration]] — orchestration layer ของ agents
- [[02 AI Systems/Agent Frameworks/Agent Frameworks - MOC]] — framework-level runtime, state, และ orchestration tradeoffs
- [[02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน]] — retrieval เป็น tool ได้
