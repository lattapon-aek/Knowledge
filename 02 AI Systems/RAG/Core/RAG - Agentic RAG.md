...
Agentic RAG คือแนวทางที่ retrieval ไม่ได้จบใน query เดียว แต่มีขั้น reasoning, query planning, subquery generation, tool use, และ iterative retrieval เข้ามาช่วย
...
ในมุมนี้ agentic RAG คือ retrieval system ที่ retrieval ถูกใส่เข้าไปใน workflow ของ agent มากขึ้น
...
นี่เป็นตัวอย่างชัดของ agentic RAG ที่มี query planning อยู่ใน retrieval layer เอง
...
- [[02 AI Systems/AI Agent Fundamentals/04 - สถาปัตยกรรม Agent: Model + Tools + Orchestration]] — orchestration layer ของ agents
- [[02 AI Systems/AI Agent Fundamentals/14 - Tools: การออกแบบและทำงาน]] — retrieval เป็น tool ได้
