...
```mermaid
flowchart LR
    A["Source Systems"] --> B["Ingestion / Indexing"]
    B --> C["Chunks + Metadata + Embeddings"]
    C --> D["Indexes / Vector Stores / Search"]
    D --> E["Query Routing"]
    E --> F["Retrieval<br/>keyword / vector / hybrid / graph / file search"]
    F --> G["Reranking"]
    G --> H["Context Assembly"]
    H --> I["Grounded Generation"]
    I --> J["Answer + Citations"]
    J --> K["Evaluation / Monitoring"]
    K --> B
    K --> E

    L["Permission / Trust Policy"] --> B
    L --> E
    L --> H
    M["Security / Guardrails"] --> H
    M --> I
    M --> J
```

ภาพนี้รวม RAG ทั้งระบบ: คุณภาพคำตอบเริ่มตั้งแต่ ingestion และ metadata ไม่ใช่แค่ retrieval ตอน query-time ส่วน permission, source trust, guardrails, eval และ monitoring ต้องคร่อมหลายชั้น
...
- [[02 AI Systems/RAG/Core/RAG - Ingestion and Indexing Pipeline|Ingestion and indexing pipeline]]
- [[02 AI Systems/RAG/Retrieval/RAG - Hybrid Retrieval|Hybrid retrieval]]
- [[02 AI Systems/RAG/Retrieval/RAG - Query Routing and Retrieval Strategy|Query routing and retrieval strategy]]
- [[02 AI Systems/RAG/Retrieval/RAG - Multi-Source Retrieval|Multi-source retrieval]]
- [[02 AI Systems/RAG/Retrieval/RAG - Metadata Filtering and Permission-Aware Retrieval|Metadata filtering and permission-aware retrieval]]
- [[02 AI Systems/RAG/Retrieval/RAG - Hierarchical and Parent-Child Retrieval|Hierarchical and parent-child retrieval]]
- [[02 AI Systems/RAG/Retrieval/RAG - Knowledge Graph RAG|Knowledge Graph RAG]]
- [[02 AI Systems/RAG/Retrieval/RAG - Multimodal RAG|Multimodal RAG]]
- [[02 AI Systems/RAG/Core/RAG - Security and Source Trust|Security and source trust]]
...
5. [[04 Synthesis/Bridge/Synthesis - Weights, Context, Retrieval และ Tools]]
...
3. [[02 AI Systems/RAG/Core/RAG - Ingestion and Indexing Pipeline]]

### 4. Advanced RAG Patterns

1. [[02 AI Systems/RAG/Retrieval/RAG - Hybrid Retrieval]]
2. [[02 AI Systems/RAG/Retrieval/RAG - Query Routing and Retrieval Strategy]]
3. [[02 AI Systems/RAG/Retrieval/RAG - Multi-Source Retrieval]]
4. [[02 AI Systems/RAG/Retrieval/RAG - Metadata Filtering and Permission-Aware Retrieval]]
5. [[02 AI Systems/RAG/Retrieval/RAG - Hierarchical and Parent-Child Retrieval]]
...
1. [[04 Synthesis/Decision/Synthesis - Agent vs Workflow vs RAG]]
2. [[04 Synthesis/Decision/Synthesis - Prompting vs Fine-tuning vs RAG]]
...
ไม่มี pending note จาก ingest plan รอบนี้

Source preparation:
- [[00 Raw Sources/Articles/Advanced RAG and Agentic RAG - Ingest Plan]]
