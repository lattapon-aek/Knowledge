...
Claude Code คือ **CLI tool** จาก Anthropic สำหรับ **Agentic Coding** — พร้อมใช้งานจริงใน production
...
| **เข้าถึงไฟล์** | ไม่ได้ (ต้อง upload เอง) | ได้โดยตรง — อ่าน/เขียน/แก้ไขทุกไฟล์ |
| **รันโค้ด** | ไม่ได้ | ได้ — รัน bash, test, build จริง |
| **รู้จักโปรเจกต์** | ไม่รู้ | รู้ทั้งหมด — อ่าน codebase เองได้ |
...
ทั้งหมดนี้เกิดขึ้น **โดยไม่ต้องให้คนมานั่งดูทุก step**
