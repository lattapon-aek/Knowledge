...
- [[02 AI Systems/AI Agent Fundamentals/07 - รูปแบบ Agent Architectures|Agent Architectures]] — กรณีที่ 1 (Parallel review) = Multi-Agent Workflows / กรณีที่ 2 (Sequential JS→TS) = Tool-Using + CodeAct
- [[02 AI Systems/AI Agent Fundamentals/09 - เมื่อไรควรและไม่ควรใช้ Agent|เมื่อไรควรใช้ Agent]] — Decision framework ว่าเมื่อไรใช้ agent แบบใด ตรงกับหลักเลือกในกรณีศึกษาเหล่านี้
