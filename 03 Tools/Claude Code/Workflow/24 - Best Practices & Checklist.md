...
- [[02 AI Systems/AI Agent Fundamentals/Reference/10 - Risks และ Best Practices|Best Practices ทฤษฎี]] — Privacy-by-Design, Guardrails, Monitoring, Incident Response ในทฤษฎี ตรงกับ checklist นี้
- [[05 Use Cases/Decision/Use Cases - When to Use an Agent|Decision Framework]] — เกณฑ์ตัดสินใจว่าเมื่อไรควรใช้ Agent ระดับใด ก่อนใช้ checklist นี้
