...
| ต้องการ | ไปอ่าน |
|---|---|
| agent concept / loop / orchestration | [[02 AI Systems/AI Agent Fundamentals/Core/04 - สถาปัตยกรรม Agent_ Model + Tools + Orchestration]] |
| harness engineering / Agent = Model + Harness | [[02 AI Systems/AI Agent Fundamentals/Core/08 - Harness Engineering]] |
| harness controls (guides vs sensors) | [[02 AI Systems/AI Agent Fundamentals/Core/09 - Guides vs Sensors]] |
| harness patterns (Generator-Evaluator, Ralph Loop ฯลฯ) | [[02 AI Systems/Agent Frameworks/Core/08 - Harness Patterns]] |
| state / memory in framework runtime | [[02 AI Systems/Agent Frameworks/Core/03 - State and Memory]] |
| tools / capability layer | [[02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน]] |
...
| harness co-evolution / lifecycle | [[04 Synthesis/Bridge/Synthesis - Harness Co-Evolution and Lifecycle]] |
