...
|---|---|---|---|
| LLM foundations | `01 Foundations/LLM Foundations` | `LLM Foundations - MOC` | `01 Foundations/LLM Foundations/Bridge/12 - LLM พื้นฐาน` |
| Prompt design | `01 Foundations/Prompt Engineering` | `Prompt Engineering - MOC` | `01 Foundations/Prompt Engineering/Bridge/13 - Messages, System Prompt และ Chat Templates` |
...
| MCP / protocol layer | `02 AI Systems/MCP` | `MCP - MOC` | `02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน` |
...
| Tool runtime contract | `02 AI Systems/MCP` + `06 Engineering` | `02 AI Systems/MCP/Bridge/14 - Tools_ การออกแบบและทำงาน` / `06 Engineering/Architecture to Code/Architecture - Tool Schemas and Runtime Integration` |
...
| Multimodal RAG | `02 AI Systems/RAG` | `RAG - Multimodal RAG` |
| Agent system design space / future directions | `04 Synthesis` | `Synthesis - Open Design Directions for Agent Systems` |
| Harness engineering | `02 AI Systems/AI Agent Fundamentals` | `08 - Harness Engineering` |
| Harness patterns | `02 AI Systems/Agent Frameworks` | `08 - Harness Patterns` |
| Harness co-evolution | `04 Synthesis` | `Synthesis - Harness Co-Evolution and Lifecycle` |
