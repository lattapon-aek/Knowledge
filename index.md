...
flowchart LR
    ...
    E --> F
    C --> G["Tools"]
    F --> H["Recipes / Decisions / Project Notes"]

    B --> B1["LLM / Prompt / Context / Tokenizer"]
    C --> C1["Agents / MCP / RAG / Memory / Guardrails / Evals"]
    D --> D1["Bridge / Decision synthesis"]
```

ใช้ภาพนี้เป็น navigation map: เริ่มจาก foundations เมื่อต้องการ base concepts, ไป `AI Systems` เมื่อต้องการ architecture, ไป `Synthesis`/`Use Cases` เมื่อต้องเลือกแนวทาง, และไป `Engineering` เมื่อต้อง implement
...
- [[01 Foundations/LLM Foundations/Core/01 - LLM คืออะไรและพื้นฐาน]] — นิยาม LLM และภาพรวมพื้นฐาน
- [[01 Foundations/LLM Foundations/Core/02 - สถาปัตยกรรม Transformer]] — โครงสร้าง Transformer ระดับแกน
- [[01 Foundations/LLM Foundations/Core/03 - การฝึกและ Post-Training]] — training, fine-tuning, post-training
- [[01 Foundations/LLM Foundations/Core/04 - Inference, Context และ RAG]] — inference runtime, context, และ RAG เบื้องต้น
- [[01 Foundations/LLM Foundations/Core/05 - ข้อจำกัดและการประเมินผล LLM]] — failure modes, evaluation, และข้อจำกัด
- [[01 Foundations/LLM Foundations/Core/06 - Attention และ Representations]] — attention, token interactions, representations
- [[01 Foundations/LLM Foundations/Core/07 - Logits, Decoding และ Sampling]] — decoding, logits, sampling strategies
- [[01 Foundations/LLM Foundations/Core/08 - Data, Pretraining และ Model Modes]] — data pipeline, pretraining, model modes
- [[01 Foundations/LLM Foundations/Core/09 - Serving Metrics และระบบ Production LLM]] — serving, latency, throughput, production metrics
- [[01 Foundations/LLM Foundations/Core/10 - Embeddings และ Semantic Similarity]] — embeddings, similarity, retrieval foundations
- [[01 Foundations/LLM Foundations/Core/11 - Multimodal Foundations]] — multimodal model foundations และ input/output modes
...
- [[01 Foundations/Prompt Engineering/Core/01 - Prompt Engineering คืออะไร]] — แนวคิดพื้นฐานของ prompt engineering
- [[01 Foundations/Prompt Engineering/Core/02 - องค์ประกอบของ Prompt]] — ส่วนประกอบหลักของ prompt
- [[01 Foundations/Prompt Engineering/Core/03 - Prompt Patterns พื้นฐาน]] — รูปแบบ prompt ที่ใช้บ่อย
- [[01 Foundations/Prompt Engineering/Core/04 - หลักการจากหลายบริษัท]] — หลักการ prompting จากหลายผู้ให้บริการ
- [[01 Foundations/Prompt Engineering/Core/05 - Evaluation และ Failure Modes]] — วิธีวัดผลและข้อผิดพลาดของ prompts
- [[01 Foundations/Prompt Engineering/Core/06 - Template และ Common Problems]] — template patterns และปัญหาที่พบบ่อย
- [[01 Foundations/Prompt Engineering/Core/07 - Structured Generation และ Output Formats]] — structured outputs, schemas, output contracts

### Context Windows

- [[01 Foundations/Context Windows/Context Windows - MOC|Context Windows - MOC]] — หน้าแม่ของ context windows ทั้งหมวด
- [[01 Foundations/Context Windows/Core/01 - Context Window คืออะไร]] — นิยาม context window, token budget, context rot
- [[01 Foundations/Context Windows/Core/02 - การบริหารและ Context Engineering]] — layout, token counting, RAG vs long context
- [[01 Foundations/Context Windows/Core/03 - Prompt Caching]] — prompt caching, ROI, และ cost/latency tradeoffs

### Tokenizer in AI

- [[01 Foundations/Tokenizer in AI/Tokenizer in AI - MOC|Tokenizer in AI - MOC]] — หน้าแม่ของ tokenizer ทั้งหมวด
- [[01 Foundations/Tokenizer in AI/Core/01 - Tokenization คืออะไร]] — นิยาม tokenization
- [[01 Foundations/Tokenizer in AI/Core/02 - ประเภทของ Tokenization]] — ประเภทของ tokenization
- [[01 Foundations/Tokenizer in AI/Core/03 - อัลกอริทึม BPE และ Byte-level BPE]] — BPE และ byte-level BPE
- [[01 Foundations/Tokenizer in AI/Core/04 - WordPiece และ SentencePiece]] — WordPiece และ SentencePiece
- [[01 Foundations/Tokenizer in AI/Core/05 - Tokenizer Pipeline]] — pipeline ของ tokenizer
- [[01 Foundations/Tokenizer in AI/Core/06 - ทำไม Tokenization ถึงสำคัญ]] — ผลกระทบของ tokenization ต่อระบบ
- [[01 Foundations/Tokenizer in AI/Core/07 - เปรียบเทียบ Tokenizer รายโมเดล]] — เปรียบเทียบ tokenizer ของโมเดลต่าง ๆ
...
- [[02 AI Systems/RAG/Retrieval/RAG - Query Routing and Retrieval Strategy]] — decision layer สำหรับเลือก retrieval path
...
- [[02 AI Systems/Evals/Core/02 - Benchmark Design]] — ออกแบบ benchmark และ eval set
- [[02 AI Systems/Evals/Core/03 - LLM-as-Judge]] — LLM-as-judge patterns และข้อควรระวัง
- [[02 AI Systems/Evals/Core/04 - Human Evaluation]] — human review และ human-in-the-loop evaluation
- [[02 AI Systems/Evals/Core/05 - Regression Testing]] — regression testing สำหรับ AI systems
...
- [[02 AI Systems/Evals/Core/09 - Observability and Feedback Loops]] — observability และ feedback loops
...
- [[02 AI Systems/Guardrails/Core/Guardrails - Prompt Injection and Content Attacks]] — prompt injection และ content attack risks
...
- [[02 AI Systems/Guardrails/Core/07 - Safety vs Usability Tradeoffs]] — trade-offs ระหว่าง safety และ usability

### Synthesis

- [[04 Synthesis/Synthesis - MOC|Synthesis - MOC]] — หน้าแม่ของโน้ตสังเคราะห์
- [[04 Synthesis/Bridge/Synthesis - Agent Runtime Layers]] — runtime layering ของ agent systems
- [[04 Synthesis/Bridge/Synthesis - Weights, Context, Retrieval และ Tools]] — แยกแหล่งความสามารถหลักของ LLM systems
- [[04 Synthesis/Decision/Synthesis - Workflow vs AI Agent]] — เปรียบเทียบ workflow กับ agent
- [[04 Synthesis/Decision/Synthesis - Agent vs Workflow vs RAG]] — แยก agent, workflow, และ RAG
- [[04 Synthesis/Bridge/Synthesis - LLM to Agent Stack]] — stack จาก LLM primitive ไป agent system
- [[04 Synthesis/Bridge/Synthesis - Memory in Agents]] — memory ใน agent systems
- [[04 Synthesis/Bridge/Synthesis - Memory vs RAG vs Context]] — แยก memory, RAG, และ context
- [[04 Synthesis/Decision/Synthesis - Prompting vs Fine-tuning vs RAG]] — เปรียบเทียบ prompting, fine-tuning, และ RAG
- [[04 Synthesis/Bridge/Synthesis - Safety, Reliability, and Evals]] — เชื่อม safety, reliability, guardrails, และ evals
...
- [[05 Use Cases/Decision/Use Cases - When to Use an Agent]] — decision path ว่าควรใช้ agent เมื่อไร
- [[05 Use Cases/Application/Use Cases - Build an AI Agent]] — เส้นทางสร้าง agent
- [[05 Use Cases/Decision/Use Cases - Choose an Agent Framework]] — เลือก framework จาก runtime needs
- [[05 Use Cases/Application/Use Cases - Design a RAG System]] — ออกแบบ RAG system
- [[05 Use Cases/Application/Use Cases - Design Guardrails for Tool Use]] — วาง guardrails สำหรับ tool use
- [[05 Use Cases/Application/Use Cases - Design Memory for an AI Agent]] — วาง memory สำหรับ agent
- [[05 Use Cases/Application/Use Cases - Evaluate an AI Agent]] — ออกแบบ evals สำหรับ agent
- [[05 Use Cases/Application/Use Cases - Explain MCP Quickly]] — อธิบาย MCP เร็ว ๆ
- [[05 Use Cases/Application/Use Cases - Improve Prompt Reliability]] — ปรับ prompt reliability
- [[05 Use Cases/Decision/Use Cases - Move from Single to Multi-Agent]] — decision path สำหรับย้ายจาก single-agent ไป multi-agent
...
- [[03 Tools/Claude Code/Core/01 - Claude Code คืออะไร]] — ภาพรวม Claude Code
- [[03 Tools/Claude Code/Core/02 - เปรียบเทียบ Agentic Coding Tools]] — เปรียบเทียบเครื่องมือ coding agents
- [[03 Tools/Claude Code/Core/03 - Orchestrator Pattern]] — orchestrator pattern
- [[03 Tools/Claude Code/Workflow/04 - 1 Session vs Subagents vs Agent Teams]] — รูปแบบการแบ่งงานของ agents
- [[03 Tools/Claude Code/Core/05 - รูปแบบการใช้งาน Multi-Agent]] — การใช้งาน multi-agent
- [[03 Tools/Claude Code/Core/06 - การควบคุมต้นทุน]] — cost control
- [[03 Tools/Claude Code/Reference/07 - การติดตั้งและเริ่มใช้งาน]] — setup และ getting started
- [[03 Tools/Claude Code/Reference/08 - Display Mode (In-Process vs Split Panes)]] — display modes
- [[03 Tools/Claude Code/Reference/09 - Permissions และ Settings]] — permissions และ settings
- [[03 Tools/Claude Code/Reference/10 - Session Management และ Commands]] — session management และ commands
- [[03 Tools/Claude Code/Reference/11 - โครงสร้างโฟลเดอร์ .claude]] — โครงสร้าง `.claude`
- [[03 Tools/Claude Code/Reference/12 - CLAUDE File]] — ไฟล์ `CLAUDE`
- [[03 Tools/Claude Code/Reference/13 - Custom Commands]] — custom commands
- [[03 Tools/Claude Code/Reference/14 - Built-in Subagents]] — built-in subagents
- [[03 Tools/Claude Code/Reference/15 - สร้าง Subagent ด้วย agents]] — การสร้าง subagents
- [[03 Tools/Claude Code/Core/16 - บทบาท Frontend, Backend, QA]] — role-based agents
- [[03 Tools/Claude Code/Workflow/17 - Agent Tool]] — agent tool
- [[03 Tools/Claude Code/Workflow/18 - Git Worktree]] — git worktree workflow
- [[03 Tools/Claude Code/Workflow/19 - วิธีเริ่ม Agent Team]] — เริ่ม agent team
- [[03 Tools/Claude Code/Core/20 - Multi-Provider AI]] — multi-provider setup
- [[03 Tools/Claude Code/Core/21 - กรณีศึกษา]] — case studies
- [[03 Tools/Claude Code/Workflow/22 - Error Handling]] — error handling
- [[03 Tools/Claude Code/Workflow/23 - ข้อจำกัด Agent Teams]] — limitations ของ agent teams
- [[03 Tools/Claude Code/Workflow/24 - Best Practices & Checklist]] — best practices และ checklist
- [[03 Tools/Claude Code/Core/25 - Context Compaction Pipeline]] — 5-layer graduated context compaction
- [[03 Tools/Claude Code/Core/26 - Extensibility Mechanisms]] — 4 extension mechanisms (MCP, plugins, skills, hooks)
- [[03 Tools/Claude Code/Core/27 - Claude Code vs OpenClaw]] — comparative architecture กับ OpenClaw
- [[03 Tools/Claude Code/Core/28 - Session Persistence and Recovery]] — append-only persistence, resume/fork

---

## Synthesis

- [[04 Synthesis/Decision/Synthesis - Agent vs Workflow vs RAG]] — เปรียบเทียบ 3 แนวทางหลักของระบบ LLM
- [[04 Synthesis/Bridge/Synthesis - Agent Runtime Layers]] — แยกชั้น runtime ของระบบ agent ให้เห็นภาพรวม
- [[04 Synthesis/Bridge/Synthesis - LLM to Agent Stack]] — แผนที่จาก LLM ไปสู่ agent stack
- [[04 Synthesis/Bridge/Synthesis - Safety, Reliability, and Evals]] — เชื่อม safety controls เข้ากับ reliability และ evaluation
- [[04 Synthesis/Bridge/Synthesis - Memory vs RAG vs Context]] — แยกหน้าที่ของ context, memory, และ RAG
- [[04 Synthesis/Bridge/Synthesis - Memory in Agents]] — memory patterns ใน agents
- [[04 Synthesis/Decision/Synthesis - Prompting vs Fine-tuning vs RAG]] — เปรียบเทียบ 3 วิธีปรับระบบให้ดีขึ้น
...
- [[05 Use Cases/Application/Use Cases - Build an AI Agent]] — เส้นทางใช้งานจริงในการสร้าง agent
- [[05 Use Cases/Decision/Use Cases - Choose an Agent Framework]] — วิธีคิดเลือก framework จาก runtime needs
- [[05 Use Cases/Application/Use Cases - Design a RAG System]] — วิธีคิดออกแบบ retrieval pipeline, grounding, และ evaluation ของ RAG
- [[05 Use Cases/Application/Use Cases - Design Guardrails for Tool Use]] — วิธีวาง guardrails สำหรับ tools, permissions, และ fallback
- [[05 Use Cases/Application/Use Cases - Design Memory for an AI Agent]] — วิธีแยก memory, RAG, และ context ในระบบ agent
- [[05 Use Cases/Application/Use Cases - Evaluate an AI Agent]] — วิธีออกแบบ evals สำหรับ agent ที่มี tools, state, และ safety constraints
- [[05 Use Cases/Application/Use Cases - Explain MCP Quickly]] — อธิบาย MCP อย่างรวดเร็ว
- [[05 Use Cases/Application/Use Cases - Improve Prompt Reliability]] — ปรับปรุง reliability ของ prompts
...
- ถ้าต้องการ workflow / standards ของ vault ให้ดู [[Home]]
